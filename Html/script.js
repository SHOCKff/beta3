...
<div id="All_languages">
 ...
 <label>
     <select id="dropdown">
         <option class="dropclass" value=0>ENGLISH</option>
         <option class="dropclass" value=38>TELUGU</option>
         <option class="dropclass" value=37>HINDI</option>
         <option class="dropclass" value=43>TAMIL</option>
         <option class="dropclass" value=42>PUNJABI</option>
         <option class="dropclass" value=40>MALAYALAM</option>
         <option class="dropclass" value=12>TURKISH</option>
         <option class="dropclass" value=4>FRENCH</option>
     </select>
 </label>
 <br>
 <br>
...
setting.onclick=()=>{
    if(settingval%2==0){
      ...
      for(i of dropclass){
      if((localStorage.getItem("Trans_lang")==i.getAttribute("value"))){
         i.selected=true;
         console.log(i)
         };
       };
...
autoclose=()=>{
  setTimeout(()=>{
    work.setAttribute("style","display:none");setting.innerText="⚙️";},10000);
};
Transval=0;
let nedar=[];
